...
# v51: combine Opus 4.7, pinned OpenCode deps, and MP4 browser recordings
CACHE_BUSTER = "v51-opus-4-7-opencode-deps-video"
...
base_image = (
    ...
    .run_commands(
        ...
        f'"dependencies":{{"@opencode-ai/plugin":"{OPENCODE_VERSION}","zod":"*"}}}}\''
