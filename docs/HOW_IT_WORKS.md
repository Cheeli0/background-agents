...
> Other opt-in providers use the key listed in [Available Models](./AVAILABLE_MODELS.md). SuperGrok
> models require an xAI provider account or `XAI_API_KEY` mode. Opt-in providers must be enabled
