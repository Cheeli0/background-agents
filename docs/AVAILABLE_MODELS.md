...
OpenCode Zen and OpenCode Go require `OPENCODE_API_KEY`; Z.AI Coding Plan requires `ZHIPU_API_KEY`;
DeepSeek requires `DEEPSEEK_API_KEY`. Other API-key providers require the matching global,
environment, or repository secret described below.
...
| `zai-coding-plan/glm-5.3`       | GLM 5.3       | Z.AI Coding Plan | low, high, max    | high           |
