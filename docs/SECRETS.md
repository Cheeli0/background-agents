...
`ZHIPU_API_KEY`; MiniMax Coding Plan uses `MINIMAX_API_KEY`; Fireworks uses `FIREWORKS_API_KEY`;
OpenCode Go uses `OPENCODE_GO_API_KEY`; and Ollama Cloud uses `OLLAMA_CLOUD_API_KEY`. For
